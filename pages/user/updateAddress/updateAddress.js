...
Page({
  ...
  data: {
    ...
    show: false,//用于判断弹出层弹出状况,
    phoneWarning:'',
    cityinfor:'所在地区',//城市选择标签
    //提交的数据
    phoneinput:'',
    nameinput:'',
    cityinput:'',
  ...
  cityConfirm(e){
    ...
    this.data.cityinput=e.detail.values
    var cityinput=this.citydataDone(this.data.cityinput)
    this.setData({
      cityinput:cityinput,
      cityinfor:cityinput
    })
  ...
  submit(){
    ...
    if(judge){
      //提交数据
      var phoneinput = this.data.phoneinput
      var nameinput = this.data.nameinput
      var cityinput = this.data.cityinput  
      ...
      request({
        url: this.data.WEB + '/api/user/UpdataAddByid',
        method: 'post',
        data: {
          userid: userid,
          addressid: addressid,
  ...
  subjudge(){
    ...
    else if(this.data.addressinput.length<5||this.data.addressinput.length>120){
      wx.showModal({
        content: '详细地址长度需要在5~120个字符之间',
        showCancel:false
      })
      return false
    }else{
  ...
  onShow: function () {
    ...
    request({
      ...
      this.setData({
        ...
        addressinput: res.data['address'],
        cityinfor: res.data['city']
      })
